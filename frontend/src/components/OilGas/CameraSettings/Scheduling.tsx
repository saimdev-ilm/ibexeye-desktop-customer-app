...
const Scheduling: React.FC = () => {
  ...
  return (
    <div className="space-y-2">
      <h2 className="text-lg font-semibold text-gray-600">Schedules List</h2>
      {/* Schedule List */}
      {schedules.length > 0 ? (
      ...
      {showPopup && (
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-gray-900 bg-opacity-50">
          <div className="absolute z-[1000000] p-6 space-y-4 bg-white rounded shadow-lg w-80">
      ...
      <div className="flex items-center justify-end">
        <button
          ...
          className="flex items-center gap-2 px-3 py-2 text-customBlue hover:text-blue-600"
        >
