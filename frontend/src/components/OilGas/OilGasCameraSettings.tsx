...
const OilGasCameraSettings = () => {
  ...
  const settings: SettingType[] = [
    { name: "Video Settings", component: <VideoSettings /> },
  ...
  return (
    <div className="">
      <div className="bg-white shadow rounded-3xl h-[78vh] overflow-hidden">
        {activeSetting === null ? (
          <>
...
export default OilGasCameraSettings;
